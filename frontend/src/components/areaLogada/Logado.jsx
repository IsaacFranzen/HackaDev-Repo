...
const LogadoArea = () => {
  ...
  return (
    <>
      <div style={estilo}>
        <h2 style={Title}>Olá, Seja bem-vindo Fulano !</h2>

        <section style={sectionSaldo}>
          <a href="#" onClick={() => setTransferVisible(true)} style={linkTransfer}>Transferência</a>
          ...
          <a href="/saldo" style={linkSaldo}>Acessar página do saldo</a>
        </section>

        <div style={{ marginTop: "7%", padding: "0 100px" }}>
          <div style={historicoLinkTitle}>
            <a href="/saldo" style={linkTransacoes}>Acessar histórico de transações</a>
